...
public class exportToCSV {
    ...
    public static void getWaitingTimes(Sink sink) {
        try {
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter(Region.numAmbulances + "_ambulancesResults.csv"));
            // column names
            writer.write("Shift");
            writer.write(",");
            writer.write("Avg. WT A1");
            writer.write(",");
            writer.write("Avg. WT A2");
            writer.write(",");
            writer.write("Avg. WT B");
            writer.write(",");
            ...
            // Shifts 4-4-4-4-4-4
            int[] shift_times = new int[] { 0, 60 * 4, (60 * 4) * 2, (60 * 4) * 3, (60 *
                    4) * 4, (60 * 4) * 5,
                    (60 * 4) * 6 };
